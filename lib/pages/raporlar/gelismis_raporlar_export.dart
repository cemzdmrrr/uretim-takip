        ...
        pdf.addPage(
          pw.MultiPage(
            ...
            header: (pw.Context ctx) => pw.Column(
              ...
              children: [
                pw.Text('TexPilot - Rapor Ozeti',
                    style: pw.TextStyle(
                        fontSize: 18, fontWeight: pw.FontWeight.bold)),
                pw.SizedBox(height: 4),
                pw.Text('Olusturulma: $now',
                    style: const pw.TextStyle(fontSize: 10)),
                if (secilenMarka != null)
                  pw.Text('Marka: $secilenMarka',
                      style: const pw.TextStyle(fontSize: 10)),
                if (secilenModel != null)
                  pw.Text('Model: $secilenModel',
                      style: const pw.TextStyle(fontSize: 10)),
                pw.Divider(),
              ],
            ),
            ...
            build: (pw.Context ctx) => [
              ...
              pw.TableHelper.fromTextArray(
                ...
                data: [
                  ...
                  [
                    'Kar Marji',
                    '%${(ozet['karMarji'] as num).toStringAsFixed(1)}'
                  ],
                ],
              ),
              ...
              pw.TableHelper.fromTextArray(
                ...
                data: [
                  [
                    'Iplik',
                    currencyFormat.format(maliyetDagilimi['iplik']),
                    '%${maliyetDagilimi['iplikOran'].toStringAsFixed(1)}'
                  ],
                  [
                    'Iscilik',
                    currencyFormat.format(maliyetDagilimi['iscilik']),
                    '%${maliyetDagilimi['iscilikOran'].toStringAsFixed(1)}'
                  ],
                  [
                    'Aksesuar',
                    currencyFormat.format(maliyetDagilimi['aksesuar']),
                    '%${maliyetDagilimi['aksesuarOran'].toStringAsFixed(1)}'
                  ],
                  [
                    'Genel Gider',
                    currencyFormat.format(maliyetDagilimi['genelGider']),
                    '%${maliyetDagilimi['genelGiderOran'].toStringAsFixed(1)}'
                  ],
                ],
              ),
              pw.SizedBox(height: 16),
              ...
              // RENK ANALİZİ
              pw.Text('Renk Bazli Satis Analizi (ilk 10)',
                  style: pw.TextStyle(
                      fontSize: 14, fontWeight: pw.FontWeight.bold)),
              pw.SizedBox(height: 8),
              pw.TableHelper.fromTextArray(
              ...
              pw.TableHelper.fromTextArray(
                ...
                data: [
                  [
                    'Ortalama Satis Suresi',
                    '${stokDevir['ortalamaSure'].toStringAsFixed(1)} gun'
                  ],
              ...
              // MODEL DETAY TABLOSU
              pw.Text('Model Detaylari (${filtrelenmisModeller.length} kayit)',
                  style: pw.TextStyle(
                      fontSize: 14, fontWeight: pw.FontWeight.bold)),
              pw.SizedBox(height: 8),
              pw.TableHelper.fromTextArray(
                ...
                data: filtrelenmisModeller.take(100).map((item) {
                  final adet =
                      ((item['toplam_adet'] ?? item['adet'] ?? 0) as num)
                          .toInt();
  ...
  Future<void> _excelOlustur() async {
    ...
    for (var item in filtrelenmisModeller) {
      ...
      exportData.add({
        ...
        'iscilik_maliyeti':
            (orgu + dikim + utu + yikama + ilik).toStringAsFixed(2),
        'aksesuar_maliyeti':
            (aksesuar + genelAksesuar + fermuar).toStringAsFixed(2),
