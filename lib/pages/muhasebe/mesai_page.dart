...
class _MesaiPageState extends State<MesaiPage> {
  ...
  Future<void> _getToplamMesai() async {
    ...
    aylikFazlaMesai = await MesaiService()
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              title: Text(m['tarih'] == null
                                  ? 'Tarih seçiniz'
                                  : '${m['tarih'].day}.${m['tarih'].month}.${m['tarih'].year}'),
                              subtitle: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
                                      'Başlangıç: ${m['baslangic_saati'] ?? '-'}'),
                                  ...
                                  if ((m['yemek_ucreti'] as num?)?.toDouble() !=
                                      ...
                                      (m['yemek_ucreti'] as num?)!.toDouble() >
                                          0)
                                    Text(
                                        'Yemek Ücreti: ${(m['yemek_ucreti'] as num).toDouble().toStringAsFixed(2)} TL',
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (mesaiId.isEmpty) {
                                          context.showSnackBar(
                                              'Bu kaydın ID bilgisi yok, silme/düzenleme yapılamaz. Lütfen yeni bir kayıt ekleyin.');
                                          return;
                                        }
                                        DateTime? seciliTarih = mItem['tarih'];
                                        final String baslangicSaati =
                                            mItem['baslangic_saati']
                                                    ?.toString() ??
                                                '';
                                        final String bitisSaati =
                                            mItem['bitis_saati']?.toString() ??
                                                '';
                                        String mesaiTuru =
                                            mItem['mesai_turu']?.toString() ??
                                                '';
                                        String onayDurumu =
                                        ...
                                        double yemekUcreti =
                                            (mItem['yemek_ucreti'] as num?)
                                                    ?.toDouble() ??
                                                0.0;
                                        final yemekUcretiController =
                                            TextEditingController(
                                                text: yemekUcreti.toString());
                                        TimeOfDay? baslangicTime =
                                            baslangicSaati.isNotEmpty &&
                                                    baslangicSaati.contains(':')
                                                ? TimeOfDay(
                                                    hour: int.tryParse(
                                                            baslangicSaati
                                                                .split(
                                                ...
                                                : null;
                                        TimeOfDay? bitisTime = bitisSaati
                                                    .isNotEmpty &&
                                                bitisSaati.contains(':')
                                            ? TimeOfDay(
                                                hour: int.tryParse(bitisSaati
                                                        .split(':')[0]) ??
                                                    0,
                                                minute: int.tryParse(bitisSaati
                                                        .split(':')[1]) ??
                                                    0,
                                              )
                                            : null;
                                                    ...
                                                    if (mesaiTuru == 'Pazar') {
                                                      ...
                                                      mesaiUcret =
                                                          saatlikUcret *
                                                              ...
                                                              mesaiSaati;
                                                      yemekUcreti =
                                                          0; // Saatlik mesai için yemek ücreti yok
                                                    }
      ...
      onPressed: () async {
        ...
        if (isAdmin) {
          try {
            ...
            personelList = personeller
                .map((p) => {'id': p.userId, 'ad': '${p.ad} ${p.soyad}'.trim()})
                .toList();
          } catch (e) {
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                                          ...
                                          Text(
                                            baslangicSaati == null
                                                ...
                                                : baslangicSaati!
                                                    .format(context),
                                            style: TextStyle(
                                              color: baslangicSaati == null
                                                  ? Colors.grey
                                                  : Colors.orange,
                                              fontWeight: baslangicSaati == null
                                                  ? FontWeight.normal
                                                  : FontWeight.bold,
                                            ),
                                          ),
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(
                                              color: bitisSaati == null
                                                  ? Colors.grey
                                                  : Colors.orange,
                                              fontWeight: bitisSaati == null
                                                  ? FontWeight.normal
                                                  : FontWeight.bold,
                                            ),
                                          ),
                            ...
                            DropdownButtonFormField<String>(
                              initialValue:
                                  mesaiTuru.isEmpty ? null : mesaiTuru,
                              items: const [
                                DropdownMenuItem(
                                    value: 'Pazar',
                                    child: Text(
                              ...
                              onChanged: (v) async {
                                ...
                                // Mesai türüne göre sistem ayarlarından varsayılan yemek ücretini çek
                                if (mesaiTuru == 'Pazar') {
                                  final pazarUcret = await SistemAyarlariService
                                      .getPazarYemekUcreti();
                                  setState(() {
                                    yemekUcreti = pazarUcret;
                                    yemekUcretiController.text =
                                        pazarUcret.toString();
                                  });
                            ...
                            if (mesaiTuru == 'Pazar' ||
                              ...
                              TextFormField(
                                ...
                                style: const TextStyle(color: Colors.orange),
                                onChanged: (v) =>
                                    yemekUcreti = double.tryParse(v) ?? 0,
                              ),
                            ],
                          ],
                        ),
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              if (baslangicSaati == null) {
                                context.showSnackBar(
                                    'Lütfen başlangıç saati seçin!');
                                return;
                              }
                              if (bitisSaati == null) {
                                context
                                    .showSnackBar('Lütfen bitiş saati seçin!');
                                return;
                              }
                              if (mesaiTuru.isEmpty) {
                                context
                                    .showSnackBar('Lütfen mesai türü seçin!');
                                return;
                              }
                              if (seciliPersonelId == null ||
                                  seciliPersonelId!.isEmpty) {
                                context.showSnackBar(
                              ...
                              try {
                                ...
                                ScaffoldMessenger.of(this.context).showSnackBar(
                                  const SnackBar(
                                      content: Text(
                                          'Mesai kaydı başarıyla oluşturuldu!')),
                                );
                              } catch (e, stackTrace) {
