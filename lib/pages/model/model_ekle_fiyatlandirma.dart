...
/// Model ekleme - fiyatlandirma formu
extension _FiyatlandirmaEkleExt on _ModelEkleState {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Excel formatında liste görünümü
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Vade oranı girişi (sadece vade seçilmişse görünür)
          if (_selectedVade > 0)
            IntrinsicHeight(
              child: Row(
                children: [
