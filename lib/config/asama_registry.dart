...
class AsamaTanim {
  ...
  bool get dashboardGoster =>
      asamaKodu != 'sevkiyat' &&
      asamaKodu != 'paketleme'; // sevkiyat ayrı modül, paketleme gizli
...
class AsamaRegistry {
  ...
  static List<AsamaTanim> dashboardAsamalari(String tekstilDali) {
    return asamalariGetir(tekstilDali).where((a) => a.dashboardGoster).toList();
  }
  ...
  static const Map<String, List<AsamaTanim>> _tumFallbacklar = {
    'triko': [
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'dokuma',
          asamaAdi: 'Dokuma/Örme',
          siraNo: 1,
          zorunlu: true,
          ikon: Icons.design_services,
          renk: Color(0xFF1976D2),
          eskiTabloAdi: 'dokuma_atamalari',
          eskiDurumKolonu: 'orgu_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'yikama',
          asamaAdi: 'Yıkama',
          ...
          renk: Color(0xFF00838F),
          eskiTabloAdi: 'yikama_atamalari',
          eskiDurumKolonu: 'yikama_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'nakis',
          asamaAdi: 'Nakış',
          siraNo: 3,
          ikon: Icons.brush,
          renk: Color(0xFFFF6F00),
          eskiTabloAdi: 'nakis_atamalari',
          eskiDurumKolonu: 'nakis_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'ilik_dugme',
          asamaAdi: 'İlik Düğme',
          siraNo: 4,
          ikon: Icons.radio_button_checked,
          renk: Color(0xFF7B1FA2),
          eskiTabloAdi: 'ilik_dugme_atamalari',
          eskiDurumKolonu: 'ilik_dugme_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'konfeksiyon',
          asamaAdi: 'Konfeksiyon',
          siraNo: 5,
          zorunlu: true,
          ikon: Icons.checkroom,
          renk: Color(0xFFE65100),
          eskiTabloAdi: 'konfeksiyon_atamalari',
          eskiDurumKolonu: 'konfeksiyon_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'utu',
          asamaAdi: 'Ütü',
          ...
          zorunlu: true,
          ikon: Icons.iron,
          renk: Color(0xFFAD1457),
          eskiTabloAdi: 'utu_atamalari',
          eskiDurumKolonu: 'utu_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'paketleme',
          asamaAdi: 'Paketleme',
          ...
          renk: Color(0xFF4E342E),
          eskiTabloAdi: 'paketleme_atamalari',
          eskiDurumKolonu: 'paketleme_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'kalite_kontrol',
          asamaAdi: 'Kalite Kontrol',
          siraNo: 8,
          zorunlu: true,
          ikon: Icons.verified,
          renk: Color(0xFF2E7D32),
          eskiTabloAdi: 'kalite_kontrol_atamalari',
          eskiDurumKolonu: 'kalite_durumu'),
      AsamaTanim(
          tekstilDali: 'triko',
          asamaKodu: 'sevkiyat',
          asamaAdi: 'Sevkiyat',
    ...
    'dokuma_kumas': [
      AsamaTanim(
          tekstilDali: 'dokuma_kumas',
          asamaKodu: 'cozgu',
          asamaAdi: 'Çözgü Hazırlama',
          siraNo: 1,
          zorunlu: true,
    ...
    'orme_kumas': [
      AsamaTanim(
          tekstilDali: 'orme_kumas',
          asamaKodu: 'iplik_hazirlama',
          asamaAdi: 'İplik Hazırlama',
          siraNo: 1,
          ikon: Icons.category,
          renk: Color(0xFF1976D2)),
      AsamaTanim(
    ...
    'boya_terbiye': [
      AsamaTanim(
          tekstilDali: 'boya_terbiye',
          asamaKodu: 'malzeme_kabul',
          asamaAdi: 'Malzeme Kabul',
          siraNo: 1,
          zorunlu: true,
          ikon: Icons.inventory,
          renk: Color(0xFF1976D2)),
      AsamaTanim(
          tekstilDali: 'boya_terbiye',
          asamaKodu: 'on_terbiye',
          asamaAdi: 'Ön Terbiye',
          siraNo: 2,
          ikon: Icons.science,
          renk: Color(0xFF00838F)),
      ...
      AsamaTanim(
          tekstilDali: 'boya_terbiye',
          asamaKodu: 'son_terbiye',
          asamaAdi: 'Son Terbiye',
          siraNo: 5,
          ikon: Icons.air,
          renk: Color(0xFFAD1457)),
      AsamaTanim(
    ...
    'baski_desen': [
      ...
      AsamaTanim(
          tekstilDali: 'baski_desen',
          asamaKodu: 'kalip_sablon',
          asamaAdi: 'Kalıp/Şablon',
          siraNo: 2,
          ikon: Icons.straighten,
          renk: Color(0xFF00838F)),
      AsamaTanim(
    ...
    'iplik_uretim': [
      AsamaTanim(
          tekstilDali: 'iplik_uretim',
          asamaKodu: 'hammadde_kabul',
          asamaAdi: 'Hammadde Kabul',
          siraNo: 1,
          zorunlu: true,
          ikon: Icons.inventory,
          renk: Color(0xFF1976D2)),
    ...
    'teknik_tekstil': [
      AsamaTanim(
          tekstilDali: 'teknik_tekstil',
          asamaKodu: 'malzeme_secim',
          asamaAdi: 'Malzeme Seçim',
          siraNo: 1,
          ikon: Icons.category,
          renk: Color(0xFF1976D2)),
      AsamaTanim(
