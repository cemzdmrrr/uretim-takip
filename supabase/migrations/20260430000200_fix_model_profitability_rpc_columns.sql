-- Hotfix: make profitability RPC compatible with uretim_kayitlari schemas without kabul_edilen_adet column.
-- Run this in Supabase SQL Editor after 20260430000100_create_model_costing_tables.sql.
