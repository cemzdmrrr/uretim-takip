-- Hotfix: compare profitability with cost-plus target profit ratio.
...
BEGIN
    ...
    v_durum := CASE
        ...
        WHEN v_hedef_kar_marji > 0
            AND v_gercek_toplam_maliyet > 0
            AND ((v_brut_kar / v_gercek_toplam_maliyet) * 100) + 0.05 < v_hedef_kar_marji THEN 'hedef_alti'
        ELSE 'hedefte'
    END;
